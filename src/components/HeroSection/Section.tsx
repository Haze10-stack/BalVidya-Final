...
const Section = ({ title, cards = [] }) => {
    ...
    return (
        <section className="relative py-12 px-6 bg-gray-950 overflow-hidden">
            ...
            {/* Sacred symbols in corners - more elaborate */}
...
const MysticalCard = ({ title, content, glowIntensity, delay = 0 }) => {
    return (
        <div
            className="bg-gray-900/80 border border-amber-900/30 hover:border-amber-700/50 transition-all duration-700 p-6 rounded-lg transform hover:scale-105 hover:shadow-xl hover:z-20 h-full"
            style={{
        ...
        >
            ...
            <div className="relative mb-4">
                <h3 className="text-xl font-bold text-center relative inline-block">
            ...
            {/* Card Content */}
            <div className="relative z-10 text-amber-100/80 leading-relaxed">
                {content}
            </div>
